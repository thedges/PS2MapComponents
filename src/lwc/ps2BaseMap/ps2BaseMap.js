...
export default class Ps2BaseMap extends LightningElement {
    ...
    @api
    setRecordLocation(recLat, recLng, popup) {
        console.log('child setRecordLocation called ' + recLat + ',' + recLng);
        console.log('popup ' + popup);
        if (recLat != null && recLng != null) {
            this.currAddress.latitude = recLat;
            this.currAddress.longitude = recLng;
            this.crosshairAddress = this.currAddress;
            this.recPopup = popup;
    ...
    draw() {
        ...
        console.log('enableCenterOnLocation = ' + this.enableCenterOnLocation);
        console.log('enableReverseGeocode = ' + this.enableReverseGeocode);
        ...
        */
        ...
        this.dispatchEvent(new CustomEvent('mapinit'));
    }
    ...
    setLocAddress(locAddress) {
        console.log('setLocAddress = ' + locAddress);
        this.locAddress = locAddress;
    }

    clearLocAddress() {
        console.log('clearLocAddress');
    ...
    saveLocation() {
        ...
        console.log('locAddress = ' + this.locAddress);
        ...
        var recordMarker = new L.marker(this.recPos).bindPopup(this.recPopup);
        this.recordLayer.clearLayers();
        this.recordLayer.addLayer(recordMarker);

        this.dispatchEvent(new CustomEvent('setcrosshair', { detail: this.crosshairAddress }));
    ...
    reverseGeocode(lat, lng) {
        ...
        fetch(url)
            ...
            .then(data => {
                ...
                this.recPopup = this.crosshairAddress.label;
        ...
        fetch(url)
            ...
            .then(data => {
                ...
                if (data.candidates != null && data.candidates.length > 0) {
                    ...
                    this.recPopup = this.crosshairAddress.fullAddress;
